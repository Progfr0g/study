...
Создание события
java -D'config.path=./environment.properties' -D'log4j.configurationFile=./log4j2.properties' -jar JavaLove1.jar db CREATE_NEW_EVENT auto_race competition 1 14-02-2021 150 2.5 
