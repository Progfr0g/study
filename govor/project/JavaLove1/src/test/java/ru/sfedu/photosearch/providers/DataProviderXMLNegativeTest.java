...
//    }
    ...
    void addCommentNegative() {
        String args = "XML ADD_COMMENT 5000 " + provider.getLastPhotoId() + " beautiful_photo";
        Boolean result = Main.chooseMethod(provider, Arrays.asList(args.split(Constants.UTIL_SPACE)));
        assertFalse(result);
    }
    ...
    void addRateNegative() {
        String args = "XML ADD_RATE 5000 " + provider.getLastPhotoId() + " 5";
        Boolean result = Main.chooseMethod(provider, Arrays.asList(args.split(Constants.UTIL_SPACE)));
        assertFalse(result);
    }
    @Test
    void getAllRatesNegative() {
        String args = "XML GET_ALL_RATES 5000 " + provider.getLastPhotoId();
        Boolean result = Main.chooseMethod(provider, Arrays.asList(args.split(Constants.UTIL_SPACE)));
        assertFalse(result);
    }
