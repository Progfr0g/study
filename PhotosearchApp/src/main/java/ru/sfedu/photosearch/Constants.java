...
public class Constants {
    ...
    public static final String CSV_COMMENTS_COLUMNS = "id, userId, photoId, text, rate, date";
    ...
    public static final String INSERT_COMMENTS_QUERY = "INSERT INTO %s " +
            "(userId, photoId, comment, rate, date) " +
    ...
    public static final String ERROR_PARSE_RATE = "Cannot parse rate to integer: %s. ";
    public static final String ERROR_RATE_LIMIT = "Rate should be from 0 to 5.";
    ...
    public static final String CSV_COMMENTS_OUTPUT = "%s,%s,%s,%s,%s,%s";
